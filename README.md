...
ios-store
---
**September 29th, 2013:** Server Side Verification is now implemented into ios-store. The server is a complementary server provided by [SOOMLA](http://soom.la) to help you get more secured purchases in your game. This feature is not enabled by default. In order to enable Server Side verification go to StoreConfig.m and set  **VERIFY_PURCHASES = YES**.
