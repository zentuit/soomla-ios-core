...
extern NSString *const JSON_STORE_NONCONSUMABLE;
extern NSString *const JSON_STORE_VIRTUALGOODS;
extern NSString *const JSON_STORE_VIRTUALCATEGORIES;

extern NSString *const JSON_APPSTOREITEM_PRODUCT_ID;
extern NSString *const JSON_APPSTOREITEM_CONSUMABLE;
extern NSString *const JSON_APPSTOREITEM_PRICE;
