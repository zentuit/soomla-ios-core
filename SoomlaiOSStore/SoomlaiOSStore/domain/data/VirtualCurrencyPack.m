...
@synthesize price, currencyAmount, currency, category;

- (id)initWithName:(NSString*)oName andDescription:(NSString*)oDescription
andImgFilePath:(NSString*)oImgFilePath andItemId:(NSString*)oItemId andPrice:(double)oPrice
andCurrencyAmount:(int)oCurrencyAmount andCurrency:(VirtualCurrency*)oCurrency andCategory:(VirtualCategory*)oCategory{
