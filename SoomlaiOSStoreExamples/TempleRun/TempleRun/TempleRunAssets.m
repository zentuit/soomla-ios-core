...
+ (void)initialize{
    ...
    COINS_CURRENCY = [[VirtualCurrency alloc] initWithName:@"Coins"
                           andDescription:@""
                           andImgFilePath:@"themes/templeRun/img/Item Price.png"
    ...
    BOOST_AHEAD_GOOD = [[VirtualGood alloc] initWithName:@"Boost Ahead"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Powerups/Object 11.png"
    ...
    EXTRA_HEALTH_GOOD = [[VirtualGood alloc] initWithName:@"Extra Health"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Powerups/Object 12.png"
    ...
    INVISIBILITY_HAT_GOOD = [[VirtualGood alloc] initWithName:@"Invisibility Hat"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Powerups/Object 14.png"
    ...
    HORN_OF_WAR_GOOD = [[VirtualGood alloc] initWithName:@"Horn of War"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Utilities/Object 1.png"
    ...
    FLAGSHIP_GOOD = [[VirtualGood alloc] initWithName:@"Flagship"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Utilities/Object 2.png"
                               andItemId:@"flagship"
    ...
    MYSTERY_BOX_GOOD = [[VirtualGood alloc] initWithName:@"Mystery Box"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Utilities/Object 10.png"
    ...
    WISDOM_GOD_GOOD = [[VirtualGood alloc] initWithName:@"Wisdom God"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Gods/Object 4.png"
    ...
    WIND_GOD_GOOD = [[VirtualGood alloc] initWithName:@"Wind God"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Gods/Object 5.png"
                               andItemId:@"wind_god"
    ...
    WINTER_GOD_GOOD = [[VirtualGood alloc] initWithName:@"Winter God"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Gods/Object 7.png"
    ...
    STARS_GOD_GOOD = [[VirtualGood alloc] initWithName:@"Stars God"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Gods/Object 8.png"
                               andItemId:@"stars_god"
    ...
    ARGRICULTURE_GOD_GOOD = [[VirtualGood alloc] initWithName:@"Argriculture God"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Gods/Object 15.png"
    ...
    EAGLE_GOOD = [[VirtualGood alloc] initWithName:@"Eagle"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Friends/Object 3.png"
                               andItemId:@"eagle"
    ...
    BUTTERFLY_GOOD = [[VirtualGood alloc] initWithName:@"Butterfly"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Friends/Object 9.png"
                               andItemId:@"butterfly"
    ...
    FISH_GOOD = [[VirtualGood alloc] initWithName:@"Fish"
                          ...
                          andImgFilePath:@"themes/templeRun/img/Friends/Object 13.png"
                               andItemId:@"fish"
    ...
    _2_500_COINS_PACK = [[VirtualCurrencyPack alloc] initWithName:@"2,500 Coins"
                          andDescription:@""
                          andImgFilePath:@"themes/templeRun/img/CurrencyPacks/GetCoins 1.png"
    ...
    _25_000_COINS_PACK = [[VirtualCurrencyPack alloc] initWithName:@"25,000 Coins"
                          andDescription:@""
                          andImgFilePath:@"themes/templeRun/img/CurrencyPacks/GetCoins 2.png"
    ...
    _75_000_COINS_PACK = [[VirtualCurrencyPack alloc] initWithName:@"75,000 Coins"
                          andDescription:@""
                          andImgFilePath:@"themes/templeRun/img/CurrencyPacks/GetCoins 3.png"
    ...
    _200_000_COINS_PACK = [[VirtualCurrencyPack alloc] initWithName:@"200,000 Coins"
                          andDescription:@""
                          andImgFilePath:@"themes/templeRun/img/CurrencyPacks/GetCoins 4.png"
