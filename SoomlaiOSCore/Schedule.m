...
- (BOOL)approveWithActivationTimes:(int)activationTimes {
    ...
    for(DateTimeRange* dtr in timeRanges) {
        ...
        NSDateComponents *startComponents = [calendar components:(NSHourCalendarUnit | NSMinuteCalendarUnit) fromDate:dtr.start];
        NSDateComponents *endComponents = [calendar components:(NSHourCalendarUnit | NSMinuteCalendarUnit) fromDate:dtr.end];
